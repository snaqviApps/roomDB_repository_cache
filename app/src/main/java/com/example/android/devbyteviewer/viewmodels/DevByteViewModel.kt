...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
    ...
    // TODO_DONE: delete _playlist, playlist variables, the init block, and refreshDataFromNetwork() function.
    ...
    val playlist = vidoeRepository.videos                           // Get videos LiveData from the repository and
